...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # cметка при группе флажков с прилагательными
        Label(self,
        ...
        body_parts = ["пуnок", "большой палец ноги", "спинной мозг"]
        column = 1
    ...
    def tell_story(self):
        ...
        story += person
        story += " уже совсем отчаялся закончить дело всей своей жизни - поиск затерянного города, в котором, по легенде, обитали "
        story += noun.title()
        story += ". Но однажды "
        story += noun
        story += " и "
        ...
        story += person + " ощутил, как на его "
        story += body_part + " скатилась слезинка. "
